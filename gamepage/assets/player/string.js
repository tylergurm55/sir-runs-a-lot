...
SC.String = {
  ...
  */
  fmt() {
    ...
    const str = this.gsub(/%@([0-9]+)/, function (m) {
  ...
  */
  loc() {
    ...
    const kit = String[String.currentLanguage()];
    let str = kit[this];
...
/** @scope String @static */ {
  ...
  */
    currentLanguage() {
      let ret = (this.useAutodetectedLanguage) ? (this.browserLanguage || this.preferredLanguage || 'en') : (this.preferredLanguage || this.browserLanguage || 'en');
  ...
  */
    ...
    @returns {this}
  */
    addStringsFor(language, strings) {
